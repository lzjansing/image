...
<%@page import="com.us.common.web.Servlets" %>
<%@page import="com.us.common.utils.Exceptions" %>
<%@page import="com.us.common.utils.StringUtil" %>
...
<head>
    <meta charset="utf-8" />
    <title>${fns:getConfig('productName')} - 过分了啊！</title>
