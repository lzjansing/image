...
//            配置文件名
            scheduledFilename = getPath(fileName) + sdf.format(new Date(file.lastModified()));
    ...
    /* Compute filename, but only if datePattern is specified */
        ...
        //按配置设定文件名
        String datedFilename = getPath(fileName) + sdf.format(now);
