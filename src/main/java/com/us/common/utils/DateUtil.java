...
public class DateUtil extends org.apache.commons.lang3.time.DateUtils {
    private static String[] parsePatterns = new String[]{
            ...
            "yyyy/MM/dd", "yyyy/MM/dd HH:mm:ss", "yyyy/MM/dd HH:mm", "yyyy/MM",
            "yyyy.MM.dd", "yyyy.MM.dd HH:mm:ss", "yyyy.MM.dd HH:mm", "yyyy.MM",
            "yyyyMMdd HHmmss", "yyyyMMdd HHmm", "yyyyMMdd HH", "yyyyMMdd", "yyyyMM", "yyyy"
    };
    ...
    public static void main(String[] args) {
        System.out.println(parseDate("2016"));
        System.out.println(parseDate("2016-3"));
        System.out.println(parseDate("2016-03"));
        System.out.println(parseDate("2016-03-08"));
        System.out.println(parseDate("2016-03-08 08:08:08"));
    }
